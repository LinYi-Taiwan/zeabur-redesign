  ...
  return (
    <div className="rounded-xl border border-[var(--border)] bg-[var(--card)] p-4">
      <div className="flex items-center justify-between mb-3">
        ...
        <button className="p-1.5 hover:bg-[var(--muted)] rounded-lg transition-colors text-[var(--muted-foreground)]">
      ...
      <div className="space-y-2">
        {domains.map((domain) => (
          <button
            ...
            className="flex items-center gap-3 w-full text-left p-2.5 rounded-lg hover:bg-[var(--muted)] transition-colors group"
          >
